...
| [use-place-cutouts.md](how-to/use-place-cutouts.md) | 관데공 장소 사진·초성 표시, 누끼와 함께 촬영하기, 업데이트 범위와 검증 결과 |
...
| [2026-09-02-apple-review-eula.md](plans/2026-09-02-apple-review-eula.md) | The 1.2 rejection of 1.0.0 (4) and the one precaution that answers it — the terms agreement that was never on the 2026-08-27 list: why `/terms` is a route rather than a published page, why the no-tolerance sentence is a constant, and what Apple still needs from a person. **Read with the 2026-08-27 checklist** |
