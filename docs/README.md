...
| [2026-08-26-integration-open-items.md](plans/2026-08-26-integration-open-items.md) | What the pre-switch verification run left open, and how it closed: six app-side decisions, each as background, decision and what changed, plus the nine items still handed to the backend. **Start here if you are about to turn fixtures off, or picking up the backend list** |
