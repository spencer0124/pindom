...
// ── Color map ──
//
// `primary` resolves from the theme seed at render time rather than from a
// module constant, so overriding `token.color.primary` re-colours the loader.
// The other two are fixed by definition — a "dark"/"light" loader is not
// brand-coloured.
